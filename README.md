...
|  3   | Ripple-Carry Timing<br>[ripple-carry timing slides](slides/ripple-carry-timing.pdf)<br>Multiplexors<br>[multiplexor slides](slides/muxes.pdf)<br>Carry-select adder<br>[carry-select slides part 1](slides/carry-select-part1.pdf)<br>[carry-select slides part 2](slides/carry-select-part2.pdf)<br>Carry-lookahead adder<br>[carry-lookahead slides part 1](slides/carry-lookahead-part1.pdf)<br>[carry-lookahead slides part 2](slides/carry-lookahead-part2.pdf) | | [Lab 2 -- First breadboard lab](https://www.prairielearn.org/pl/course_instance/129541/assessment/2322227)<br>[HW2: Boolean Algebra](https://www.prairielearn.org/pl/course_instance/129541/assessment/2322305) |
